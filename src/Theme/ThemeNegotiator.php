...
namespace Drupal\multisite\Theme;
...
use Drupal\multisite\Manager\MultisiteManagerInterface;
...
class ThemeNegotiator implements ThemeNegotiatorInterface {
     ...
     *
     * @param MultisiteManagerInterface $sm
